package com.cms.util.security;

import javax.crypto.Cipher;
import javax.crypto.spec.SecretKeySpec;

public class SecurityUtil {
	private static String CMSSecretKey = "INNOCMSSECRETKEY";
	/* AES 128 bit 암호화 */
	public static String encrypt(String message) throws Exception{
	    if(message == null){
	        return null;
	    }else{
	    	SecretKeySpec secretKeySpec = new SecretKeySpec(CMSSecretKey.getBytes(), "AES");
